...
@Documented
@Constraint(validatedBy = ValidateAddToSubjectImpl.class)
@Retention(RetentionPolicy.RUNTIME)
@Target(ElementType.TYPE)
public @interface ValidateAddToSubject {
    // trường message là bắt buộc, khai báo nội dung sẽ trả về khi k hợp lệ
    String message() default "Add student to subject request invalid";
